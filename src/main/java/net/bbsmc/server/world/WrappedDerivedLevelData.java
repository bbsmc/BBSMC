...
public class WrappedDerivedLevelData extends PrimaryLevelData {
    private final DerivedLevelData derivedWorldInfo;

    public WrappedDerivedLevelData(LevelSettings p_78470_, WorldGenSettings p_78471_, Lifecycle p_78472_, DerivedLevelData derivedLevelData) {
    ...
    public static WrappedDerivedLevelData wrap(DerivedLevelData worldInfo) {
        return new WrappedDerivedLevelData(worldSettings(worldInfo), generatorSettings(worldInfo), lifecycle(worldInfo), worldInfo);
    }
