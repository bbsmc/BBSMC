...
public abstract class CraftRegionAccessor implements RegionAccessor {
    ...
    public boolean generateTree(net.minecraft.world.level.WorldGenLevel access, ChunkGenerator chunkGenerator, net.minecraft.core.BlockPos pos, RandomSource random, TreeType treeType) {
        Holder<?> gen;
        switch (treeType) {
            case BIG_TREE:
            ...
            case TALL_BIRCH:
                ...
                break;
            case CHORUS_PLANT:
                ((net.minecraft.world.level.block.ChorusFlowerBlock) Blocks.CHORUS_FLOWER).generatePlant(access, pos, random, 8);
                return true;
            case CRIMSON_FUNGUS:
        ...
        return ((net.minecraft.world.level.levelgen.feature.ConfiguredFeature<?, ?>) gen.value()).place(access, chunkGenerator, random, pos);
    }
    ...
    public <T extends Entity> T addEntity(net.minecraft.world.entity.Entity entity, CreatureSpawnEvent.SpawnReason reason, Consumer<T> function, boolean randomizeData) throws IllegalArgumentException {
        ...
        if (randomizeData && entity instanceof net.minecraft.world.entity.Mob) {
            ((net.minecraft.world.entity.Mob) entity).finalizeSpawn(getHandle(), getHandle().getCurrentDifficultyAt(entity.blockPosition()), net.minecraft.world.entity.MobSpawnType.COMMAND, (net.minecraft.world.entity.SpawnGroupData) null, null);
        }
    ...
    public net.minecraft.world.entity.Entity createEntity(Location location, Class<? extends Entity> clazz, boolean randomizeData) throws IllegalArgumentException {
        ...
        if (Boat.class.isAssignableFrom(clazz)) {
            ...
            if (Snowball.class.isAssignableFrom(clazz)) {
                ...
                entity = new net.minecraft.world.entity.projectile.FireworkRocketEntity(world, x, y, z, net.minecraft.world.item.ItemStack.EMPTY);
            }
            ...
            if (PoweredMinecart.class.isAssignableFrom(clazz)) {
                ...
                entity = new net.minecraft.world.entity.vehicle.MinecartCommandBlock(world, x, y, z);
            ...
            if (LeashHitch.class.isAssignableFrom(clazz)) {
                ...
                entity = new net.minecraft.world.entity.decoration.LeashFenceKnotEntity(world, new net.minecraft.core.BlockPos(x, y, z));
            } else {
                ...
                final net.minecraft.core.BlockPos pos = new net.minecraft.core.BlockPos(x, y, z);
                ...
                if (Painting.class.isAssignableFrom(clazz)) {
                    ...
                    if (GlowItemFrame.class.isAssignableFrom(clazz)) {
                        entity = new net.minecraft.world.entity.decoration.GlowItemFrame(world, new net.minecraft.core.BlockPos(x, y, z), dir);
                    } else {
                        entity = new net.minecraft.world.entity.decoration.ItemFrame(world, new net.minecraft.core.BlockPos(x, y, z), dir);
                    }
                }
            }
