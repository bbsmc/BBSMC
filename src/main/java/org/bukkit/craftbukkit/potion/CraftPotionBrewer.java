...
public class CraftPotionBrewer implements PotionBrewer {
    ...
    public Collection<PotionEffect> getEffects(PotionType damage, boolean upgraded, boolean extended) {
        ...
        List<net.minecraft.world.effect.MobEffectInstance> mcEffects = net.minecraft.world.item.alchemy.Potion.byName(CraftPotionUtil.fromBukkit(new PotionData(damage, extended, upgraded))).getEffects();

        ImmutableList.Builder<PotionEffect> builder = new ImmutableList.Builder<PotionEffect>();
        for (net.minecraft.world.effect.MobEffectInstance effect : mcEffects) {
