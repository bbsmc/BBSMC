...
public class CraftArt {
    ...
    static {
        ...
        for (ResourceKey<PaintingVariant> key : net.minecraft.core.Registry.PAINTING_VARIANT.registryKeySet()) {
            artworkBuilder.put(net.minecraft.core.Registry.PAINTING_VARIANT.getHolderOrThrow(key), Art.getByName(key.location().getPath()));
        }
