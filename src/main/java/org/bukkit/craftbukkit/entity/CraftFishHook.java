...
public class CraftFishHook extends CraftProjectile implements FishHook {
    ...
    public double getBiteChance() {
        ...
        if (this.biteChance == -1) {
            if (hook.level.isRainingAt(new net.minecraft.core.BlockPos(net.minecraft.util.Mth.floor(hook.getX()), net.minecraft.util.Mth.floor(hook.getY()) + 1, net.minecraft.util.Mth.floor(hook.getZ())))) {
                return 1 / 300.0;
            }
            return 1 / 500.0;
        }
