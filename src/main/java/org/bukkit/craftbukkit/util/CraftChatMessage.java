...
public final class CraftChatMessage {
            ...
            while (matcher.find()) {
                ...
                case 1:
                    ...
                    if (c == 'x') {
                        ...
                        if (hex.length() == 7) {
                            modifier = RESET.withColor(net.minecraft.network.chat.TextColor.parseColor(hex.toString()));
                            hex = null;
                        }
    ...
    private static net.minecraft.network.chat.Component fromJSONOrString(String message, boolean nullable, boolean keepNewlines) {
    ...
    public static String fromStringToJSON(String message, boolean keepNewlines) {
        net.minecraft.network.chat.Component component = CraftChatMessage.fromString(message, keepNewlines)[0];
        return CraftChatMessage.toJSON(component);
    }

    public static String fromStringOrNullToJSON(String message) {
        net.minecraft.network.chat.Component component = CraftChatMessage.fromStringOrNull(message);
        return CraftChatMessage.toJSONOrNull(component);
    }

    public static String fromJSONComponent(String jsonMessage) {
        net.minecraft.network.chat.Component component = CraftChatMessage.fromJSONOrNull(jsonMessage);
