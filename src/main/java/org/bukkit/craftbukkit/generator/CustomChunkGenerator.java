...
public class CustomChunkGenerator extends InternalChunkGenerator {
    ...
    public void createStructures(net.minecraft.core.RegistryAccess iregistrycustom, RandomState randomstate, StructureManager structuremanager, net.minecraft.world.level.chunk.ChunkAccess ichunkaccess, StructureTemplateManager structuretemplatemanager, long i) {
        ...
        random.setSeed(net.minecraft.util.Mth.getSeed(x, "should-structures".hashCode(), z) ^ i);
    ...
    public void buildSurface(net.minecraft.server.level.WorldGenRegion regionlimitedworldaccess, StructureManager structuremanager, RandomState randomstate, net.minecraft.world.level.chunk.ChunkAccess ichunkaccess) {
        ...
        for (net.minecraft.core.BlockPos lightPosition : craftData.getLights()) {
            ((ProtoChunk) ichunkaccess).addLight(new net.minecraft.core.BlockPos((x << 4) + lightPosition.getX(), lightPosition.getY(), (z << 4) + lightPosition.getZ()));
        }
    }
    ...
    @Override
    public void addDebugScreenInfo(List<String> list, RandomState randomstate, net.minecraft.core.BlockPos blockposition) {
    ...
    @Override
    public net.minecraft.world.level.NoiseColumn getBaseColumn(int i, int j, LevelHeightAccessor levelheightaccessor, RandomState randomstate) {
