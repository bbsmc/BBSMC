...
public class CraftStructureBlock extends CraftBlockEntityState<net.minecraft.world.level.block.entity.StructureBlockEntity> implements Structure {
    ...
    public void setRelativePosition(BlockVector vector) {
        ...
        getSnapshot().structurePos = new net.minecraft.core.BlockPos(vector.getBlockX(), vector.getBlockY(), vector.getBlockZ());
    }
    ...
    public void setStructureSize(BlockVector vector) {
        ...
        getSnapshot().structureSize = new net.minecraft.core.BlockPos(vector.getBlockX(), vector.getBlockY(), vector.getBlockZ());
    }
