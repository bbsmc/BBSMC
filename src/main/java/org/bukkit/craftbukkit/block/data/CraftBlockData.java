...
public class CraftBlockData implements BlockData {
    ...
    public net.minecraft.nbt.CompoundTag toStates() {
    ...
    protected static net.minecraft.world.level.block.state.properties.BooleanProperty getBoolean(Class<? extends Block> block, String name) {
        return (net.minecraft.world.level.block.state.properties.BooleanProperty) getState(block, name, false);
    }

    protected static net.minecraft.world.level.block.state.properties.BooleanProperty getBoolean(Class<? extends Block> block, String name, boolean optional) {
        return (net.minecraft.world.level.block.state.properties.BooleanProperty) getState(block, name, optional);
    }

    protected static net.minecraft.world.level.block.state.properties.EnumProperty<?> getEnum(Class<? extends Block> block, String name) {
        return (net.minecraft.world.level.block.state.properties.EnumProperty<?>) getState(block, name, false);
    }

    protected static net.minecraft.world.level.block.state.properties.IntegerProperty getInteger(Class<? extends Block> block, String name) {
    ...
    public boolean isSupported(Location location) {
        ...
        net.minecraft.core.BlockPos position = new net.minecraft.core.BlockPos(location.getBlockX(), location.getBlockY(), location.getBlockZ());
