 ...
 * <br><br>
 * <li> void applyToItem(net.minecraft.nbt.CompoundTag tag)
...
class CraftMetaItem implements ItemMeta, Damageable, Repairable, BlockDataMeta {
    ...
    private net.minecraft.nbt.CompoundTag blockData;
    ...
    final Map<String, net.minecraft.nbt.Tag> unhandledTags = new HashMap<String, net.minecraft.nbt.Tag>(); // Visible for testing only
    ...
    CraftMetaItem(net.minecraft.nbt.CompoundTag tag) {
        if (tag.contains(DISPLAY.NBT)) {
            ...
            if (display.contains(LORE.NBT)) {
                net.minecraft.nbt.ListTag list = display.getList(LORE.NBT, CraftMagicNumbers.NBT.TAG_STRING);
        ...
        if (tag.contains(BUKKIT_CUSTOM_TAG.NBT)) {
            net.minecraft.nbt.CompoundTag compound = tag.getCompound(BUKKIT_CUSTOM_TAG.NBT);
    ...
    static Map<Enchantment, Integer> buildEnchantments(net.minecraft.nbt.CompoundTag tag, ItemMetaKey key) {
        if (!tag.contains(key.NBT)) {
            return null;
        }

        net.minecraft.nbt.ListTag ench = tag.getList(key.NBT, CraftMagicNumbers.NBT.TAG_COMPOUND);
        Map<Enchantment, Integer> enchantments = new LinkedHashMap<Enchantment, Integer>(ench.size());

        for (int i = 0; i < ench.size(); i++) {
            String id = ((net.minecraft.nbt.CompoundTag) ench.get(i)).getString(ENCHANTMENTS_ID.NBT);
            int level = 0xffff & ((net.minecraft.nbt.CompoundTag) ench.get(i)).getShort(ENCHANTMENTS_LVL.NBT);
    ...
    static Multimap<Attribute, AttributeModifier> buildModifiers(net.minecraft.nbt.CompoundTag tag, ItemMetaKey key) {
    ...
    CraftMetaItem(Map<String, Object> map) {
        ...
        if (blockData != null) {
            this.blockData = (net.minecraft.nbt.CompoundTag) CraftNBTTagConfigSerializer.deserialize(blockData);
        }
        ...
        if (internal != null) {
            ...
            try {
                internalTag = net.minecraft.nbt.NbtIo.readCompressed(buf);
    ...
    void applyToItem(net.minecraft.nbt.CompoundTag itemTag) {
        if (hasDisplayName()) {
            setDisplayTag(itemTag, NAME.NBT, net.minecraft.nbt.StringTag.valueOf(displayName));
        }
        if (hasLocalizedName()) {
            setDisplayTag(itemTag, LOCNAME.NBT, net.minecraft.nbt.StringTag.valueOf(locName));
        }
        ...
        for (Map.Entry<String, net.minecraft.nbt.Tag> e : unhandledTags.entrySet()) {
    ...
    net.minecraft.nbt.ListTag createStringList(List<String> list) {
        if (list == null) {
            return null;
        }
        ...
        for (String value : list) {
            ...
            tagList.add(net.minecraft.nbt.StringTag.valueOf(version <= 0 || version >= 1803 ? value : CraftChatMessage.fromJSONComponent(value))); // SPIGOT-4935
        }

        return tagList;
    }

    static void applyEnchantments(Map<Enchantment, Integer> enchantments, net.minecraft.nbt.CompoundTag tag, ItemMetaKey key) {
        ...
        for (Map.Entry<Enchantment, Integer> entry : enchantments.entrySet()) {
            net.minecraft.nbt.CompoundTag subtag = new net.minecraft.nbt.CompoundTag();
    ...
    static void applyModifiers(Multimap<Attribute, AttributeModifier> modifiers, net.minecraft.nbt.CompoundTag tag, ItemMetaKey key) {
        ...
        for (Map.Entry<Attribute, AttributeModifier> entry : modifiers.entries()) {
            ...
            net.minecraft.nbt.CompoundTag sub = nmsModifier.save();
            if (sub.isEmpty()) {
                continue;
            }
    ...
    void setDisplayTag(net.minecraft.nbt.CompoundTag tag, String key, net.minecraft.nbt.Tag value) {
        final net.minecraft.nbt.CompoundTag display = tag.getCompound(DISPLAY.NBT);
    ...
    public BlockData getBlockData(Material material) {
        return CraftBlockData.fromData(net.minecraft.world.item.BlockItem.getBlockState(CraftMagicNumbers.getBlock(material).defaultBlockState(), blockData));
    }
    ...
    ImmutableMap.Builder<String, Object> serialize(ImmutableMap.Builder<String, Object> builder) {
        ...
        final Map<String, net.minecraft.nbt.Tag> internalTags = new HashMap<String, net.minecraft.nbt.Tag>(unhandledTags);
    ...
    static void safelyAdd(Iterable<?> addFrom, Collection<String> addTo, boolean possiblyJsonInput) {
        ...
        for (Object object : addFrom) {
            if (!(object instanceof String)) {
                ...
                addTo.add(CraftChatMessage.toJSON(net.minecraft.network.chat.Component.empty()));
            } else {
